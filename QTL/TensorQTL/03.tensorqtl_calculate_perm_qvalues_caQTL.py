...
print(len(cis_df_all[cis_df_all['study_wise_qval'] < 0.05]['phenotype_id'].unique())) #13449
print(len(cis_df_all[cis_df_all['celltype_level_qval'] < 0.05]['phenotype_id'].unique())) #14635

cis_df_all.to_csv('/media/AnalysisDisk2/Yangshichen/0_HIV_RNA/QTL/01.Dynamic/03.Result/caQTL_all_lead_perm_qvalues.csv')

...
with torch.cuda.amp.autocast():
    for test_sample in sample_list:
        ...
        model = HIVModel.load_from_checkpoint("./model/hiv_model-epoch=34-val_loss=0.2877.ckpt",map_location='cpu')
        ...
        del model
        save_data(dict_sample,'/home/share/huadjyin/home/zhouxuanchi/HIV/final_chance/HDs_IRs_IG/output/'+str(test_sample)+'.pkl')
